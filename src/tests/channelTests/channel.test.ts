...
describe("channel/details/v3 failure tests", () => {
    beforeEach(() => {
        ...
        const AuthUserId3_return = requestAuthRegister(
    ...
    test("Test 1: Undefined token", () => {
        try {
            const result = requestChannelDetailsV3(
                undefined,
...
describe("channel/join/v3 failure tests", () => {
    beforeEach(() => {
        ...
        const channelId3_return = requestChannelsCreateV3(
            AuthUserId3.token,
            "Hermione Fan Club",
            true
        );
    ...
    test("Test 1: Undefined token", () => {
        try {
            const result = requestChannelJoinV3(
                undefined,
                ChannelId1.channelId
            );
            expect(result.returnObj.error).toEqual({
