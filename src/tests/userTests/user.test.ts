...
import {
    requestUserProfileUploadPhotoV3,
...
describe("Tests for /user/profile/v3", () => {
    ...
    test("success case", () => {
        const result = requestUserProfileV3(
...
describe("Tests for /user/profile/uploadphoto/v1", () => {
    ...
    test("not a jpg", () => {
        try {
            const result = requestUserProfileUploadPhotoV3(
                user.returnObj.token,
                " http://localhost:5001/imgurl/adfnajnerkn23k4234.pdf",
                0,
                0,
                10,
                10
    ...
    test("invalid token", () => {
        try {
            const result = requestUserProfileUploadPhotoV3(
                user.returnObj.token + "a",
                "http://localhost:5001/imgurl/adfnajnerkn23k4234.jpg",
                0,
                0,
                10,
                10
